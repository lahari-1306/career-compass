...
notifications = [
  ...
  {
    "id": "notif-cat-2026",
    "title": "CAT 2026 Application Window Closing Soon",
    ...
    "eligibility_summary": "Bachelor's Degree with minimum 50% marks (45% for SC/ST/PwD). Final year students eligible.",
    "official_source": "https://iimcat.ac.in",
    "last_verified_at": "2026-09-15T11:30:00+05:30",
    "priority": "HIGH",
    "description": "Final days remaining to register for Common Admission Test (CAT) for MBA/PGDM across 21 IIMs and premier management institutions."
  },
  {
    "id": "notif-nsp-portal",
    ...
    "exam_date": "N/A (Merit & Means Based Schemes)",
    "result_date": "Phased verification from December 2026",
    "eligibility_summary": "Class 1 to PG/PhD students across central and state institutions meeting family income criteria.",
    "official_source": "https://scholarships.gov.in",
    "last_verified_at": "2026-09-15T08:00:00+05:30",
    "priority": "HIGH",
    "description": "National Scholarship Portal is accepting fresh and renewal applications for Central Sector, AICTE (Pragati & Saksham), and Ministry schemes."
  },
  {
    "id": "notif-eapcet-final",
    "title": "State EAPCET Final Phase Web Options & Allotment LIVE",
    ...
    "exam_date": "Examination Completed",
    ...
    "priority": "HIGH",
    "description": "Final phase web option entry and certificate verification for state engineering and pharmacy seats in government and private colleges."
  },
  {
    "id": "notif-afcat-res",
  ...
  },
  {
    ...
    "exam_date": "Academic Merit & Verification",
    ...
    "priority": "NORMAL",
    "description": "ISRO U R Rao Satellite Centre Bengaluru invites online applications for one-year apprenticeship training under the Apprentices Act 1961."
  },
  {
    "id": "notif-nda-cycle",
    "title": "UPSC NDA & NA 2027 Notification Timeline Announced",
    ...
    "priority": "NORMAL",
    "description": "UPSC calendar outlines upcoming NDA & NA notification release on upsc.gov.in. One Time Registration (OTR) recommended in advance."
  },
  {
    "id": "notif-jeemain-archive",
